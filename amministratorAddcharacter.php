    ...
    <section>
        ...
        <form method="POST" action="actions.php" class="container">
            ...
            <div class="form-outline">
                <textarea class="form-control" id="descrizione" name="descrizione" required rows="4"></textarea>
                <label class="form-label" for="descrizione">Descrizione</label>
            </div>

            <!-- ID Doppiatore input -->
            <div class="form-outline">
                <input type="number" id="id_doppiatore" name="id_doppiatore" class="form-control" min="0"/>
            ...
            <input type="hidden" name="action" value="characterA">
